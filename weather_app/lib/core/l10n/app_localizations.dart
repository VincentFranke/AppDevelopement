...
abstract class AppLocalizations {
  ...
  /// No description provided for @gpsAccessDeniedMessage.
  ///
  /// In en, this message translates to:
  /// **'GPS Access Denied'**
  String get gpsAccessDeniedMessage;
  ...
  /// No description provided for @viewAlreadyExistsMessage.
  ///
  /// In en, this message translates to:
  /// **'View already exists'**
  String get viewAlreadyExistsMessage;
